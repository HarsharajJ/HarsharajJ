<h1><b>Good morning… or perhaps I should say, good evening?</b></h1>
...
<table>
  <tr>
    <td width="70%">
      <h2></h2>
      <p>
        I'm <b>Harsharaj</b>, a passionate <b>AI Engineer and Full-Stack Developer</b>.<br><br>
        My journey involves:
        <ul>
        <li>Building advanced AI chatbots, RAG systems, and full-stack applications</li>
        <li>Currently mastering vector databases, LangChain, cloud technologies, and system design</li>
        <li>Experienced with FastAPI, Next.js, React Native, ChromaDB, Groq, and LangGraph</li>
        <li>Open to collaborating on AI, machine learning, deep learning, and large-scale web applications</li>
...
![ChromaDB](https://img.shields.io/badge/ChromaDB-0A0A0A?style=flat-square)
